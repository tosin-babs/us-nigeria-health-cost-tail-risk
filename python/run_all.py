...
STEPS = [
    ...
    ("Denominator tests and GPD diagnostics", "denominator"),
    ("Forgone care and medical debt", "censoring"),
    ...
    ("Figures", "exhibits"),
    ("Tool payload", "export_tool_data"),
    ("Tool page", "build_tool"),
    ("Render the tables", "make_tables"),
